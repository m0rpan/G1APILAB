...
I used the snippets from (https://docs.trefle.io/docs/examples/snippets) at _trefle.io_ . In this example I am retrieving the common name of their plants that they have in their data base. 
