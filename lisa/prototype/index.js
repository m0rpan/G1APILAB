...
app.get('/api/humidityValue1', (request,response)=>{
...
app.get('/api/humidityValue2', (request,response)=>{
...
app.get('/api/humidityValue3', (request,response)=>{
...
app.get('/api/humidityValue4', (request,response)=>{
...
app.get('/api/humidityValue5', (request,response)=>{
...
app.get('/api/humidityValue6', (request,response)=>{
...
app.get('/api/humidityValue7', (request,response)=>{
...
app.get('/api/humidityValue8', (request,response)=>{
...
app.get('/api/humidityValue9', (request,response)=>{
...
app.get('/api/humidityValue10', (request,response)=>{
